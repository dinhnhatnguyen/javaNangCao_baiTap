...
<div class="hitec-signin">
    ...
    <h2 class="form-signin-heading">Đăng Nhập Admin</h2>
    <form action="dangnhapAdminController" method="post">
        ...
        <div class="mb-3">
            ...
            <img src="CaptchaServlet" class="img-fluid mb-2" alt="CAPTCHA"/><br>
...
<%--                            <div class="mb-3">--%>
<%--                                <label for="username" class="form-label"><b>Tên đăng nhập:</b></label>--%>
<%--                                <input type="text" class="form-control" name="username" placeholder="Tên đăng nhập/Email" autofocus>--%>
<%--                            </div>--%>
<%--                            <div class="mb-3">--%>
<%--                                <label for="password" class="form-label"><b>Mật khẩu:</b></label>--%>
<%--                                <input type="password" class="form-control" name="password" placeholder="Mật khẩu" required>--%>
